...
<body class="font-sans text-gray-900 antialiased bg-gray-100 dark:bg-gray-900">
    <div class="min-h-screen flex flex-col sm:justify-start items-center pt-6 sm:pt-8 pb-12">

        <!-- Logo -->
        <div class="flex justify-center mb-6">
            <a href="/">
                <svg viewBox="0 0 62 65" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-20 w-auto">
        ...
        <div class="w-full px-6 py-4 bg-white dark:bg-gray-800 shadow-md overflow-hidden sm:rounded-lg
                    {{ isset($wide) && $wide ? 'max-w-5xl' : 'sm:max-w-md' }}">
            {{ $slot }}
        </div>
    </div>
</body>
